...
import { useVisibilityCounts } from '/lib/composables/use-visibility-counts.js';
import { useAtlasData } from '/lib/composables/use-atlas-data.js';
...
export const GraphPanel = {
    ...
    setup (props, { emit }) {
        ...
        const { atlasData, ensureAtlasLoaded } = useAtlasData({
            presentError: error => emit('runtime-error', {
